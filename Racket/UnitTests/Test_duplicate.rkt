#|
    Tests for a function to duplicate all elements in a list
...
(define duplicate-test
    (test-suite "List item duplication function"
        ...
        (check-equal? (duplicate '(2)) '(2 2) "Single element list")
        (check-equal? (duplicate '(2 3)) '(2 2 3 3) "Two element list")
        (check-equal? (duplicate '(2 3 4 5)) '(2 2 3 3 4 4 5 5) "Two element list")))
